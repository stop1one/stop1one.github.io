...
- Node features $$\mathbf h = \{ \vec h_1, \vec h_2, ..., \vec h_N \}, \vec h_i \in \mathbb R^F$$ ($$N$$: Node 수, $$F$$: Feature 수)
- Layer outputs $$\mathbf h' = \{ \vec h_1',\vec h_2', ..., \vec h_N' \}, \vec h_i' \in \mathbb R^{F'}$$ ($$F'$$: Hidden embedding 차원)

### Masked Self-attention

![MSA](https://github.com/user-attachments/assets/a20acd43-d77f-4754-8de6-09c00e962bf6)
...
- $$a(\cdot)$$: shared attentional mechanism $$\mathbb R^{F'} \times \mathbb R^{F'} \rightarrow \mathbb R$$ computes attention coefficients single-layer feedforward neural network 를 사용함
...
![MHA](https://github.com/user-attachments/assets/e6909cd8-0024-40f8-a182-859f52aeb596)
...
- 하지만 multi-attention 이 더 효율적이기에 다음과 같이 바뀔 수 있다.
    ...
    근데 이러면 $$\mathbf h' \in \mathbb R^{KF'}$$ 가 되어버리고, 그냥 concatenation 시키는건 no longer sensible 하다.
...
![Results](https://github.com/user-attachments/assets/1bbf5f35-8499-46c3-81f3-689250c446e3)
...
![t-SNE](https://github.com/user-attachments/assets/57271f9f-9821-4002-9598-c88e38d07f03)
